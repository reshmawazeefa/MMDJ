@extends('layouts.vertical', ["page_title"=> "Stock Out | List"])
                    ...
                    <div class="row mb-1 pb-2 dashed-borderStyle">
                        ...
                        <div class="col-sm-12">
                            <div class="text-sm-end mt-2 mb-2 mt-sm-0">
                                <a href="{{url('admin/stockout')}}" class="btn btn-primary waves-effect waves-light"><i
                                        class="mdi mdi-plus-circle me-1"></i> Add Stock Out</a>
                            </div>
                        </div>
                        <form id="stock-outsearchForm" class="form" method="POST" action="{{url('admin/stockout/excel')}}">
                            @csrf
                            <div class="col-lg-12">
                                <div class="row">
                                    <div class="col-lg-4">
                                    ...
                                    <div class="col-lg-4">
                                        ...
                                        <div class="form-group row">
                                            <label for="to_date" class="col-sm-5 form-label">
                                                To date
                                            </label>
                                            <div class="col-sm-7">
                                    ...
                                    <div class="col-lg-4">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <input id="stock-outsearchSubmit" class="btn btn-info" type="button"
                                            value="Search" />
                                            <input id="sales-orderearchReset" class="btn btn-info" type="button"
                                            value="Reset" />
                                            <input id="stock-outsearchExport" class="btn btn-info" type="button"
                                            value="Excel Export" />
                                            </div>
                                        </div>
                                    </div>
...
<script type="text/javascript">
    $(document).ready(function () {
        ...
        $(document).on('click', '#stock-outsearchSubmit', function (e) {
            //e.preventDefault();
            table.ajax.url(url).load();
        });

        $(document).on("click", "#stock-outsearchExport", function () {
            $('#ExportDownload').hide();
            $('#stock-outsearchExport').val("Downloading..");
            $("#stock-outsearchExport").attr("disabled", true);
            var url = "{{url('admin/stockout/excel')}}";
            ...
            $.ajax({
                ...
                success: function (d) {
                    ...
                    $('#stock-outsearchExport').val("Excel Export");
                    $("#stock-outsearchExport").attr("disabled", false);
                    $('#ExportDownload').show();
    ...
    $(".modal-body .text-center button").on("click", function (event) {
        ...
        var u = "{{url('admin/stockout/close/')}}" + '/' + $("#close-quot").val();
