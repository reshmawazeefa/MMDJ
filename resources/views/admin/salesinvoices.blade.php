                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-1 col-sm-6">
                                        <div class="me-3">
                                            <label for="customer"
                                                class="form-label">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</label>
                                            <input id="sales-orderearchExport" class="btn btn-info" type="button"
                                                value="Excel Export" />
                                        </div>
                                    </div>
                                    <div class="col-lg-1 col-sm-6">
                                        <div class="me-3">
                                            <label for="customer"
                                                class="form-label">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</label>
                                            <a href="#" style="display:none;" id="ExportDownload" class="btn btn-primary waves-effect waves-light">
                                                Download</a>
                                        </div>
                                    </div>
                                </div>
