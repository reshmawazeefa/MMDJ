...
<div class="container-fluid">
    ...
    <div class="row">
        <div class="col-12">@if(!empty($errors->all()))
            ...
            @endif
            <div class="card">
                <form method="post" class="parsley-examples" action="{{url('admin/quotation/insert')}}">
                    {{csrf_field()}}
                    <div class="card-body">
                        <div class="row mb-2">
                            <div class="col-lg-12">
                                <div class="row">
                                    ...
                                    <div class="col-lg-4 col-sm-6">
                                        <div class="me-3">
                                            ...
                                            <select name="partner2" class="contractorSelect form-control select2">
                                            </select>
                                        </div>
                                    </div>
                                    <div class="col-lg-4 col-sm-6">
                        ...
                        <div class="new-table">
                        <img src="{{request()->getSchemeAndHttpHost()}}/assets/images/products/FT50004.jpg">
                        @for ($i = 0; $i < 1; $i++)
                                ...
                                <div class="row">
                                    ...
                                    <div class="colbor col-xl-2 col-lg-2 col-md-3 col-sm-4 col-6">
                                        <div class="ech-td">
                                            ...
                                            <div class="td-value">
                                            <input type="text" name="name[]" class="form-control" value="{{request()->getHttpHost()}}/assets/images/products/FT50729.jpg">
                                            </div>
                                        </div>
                                    </div>
