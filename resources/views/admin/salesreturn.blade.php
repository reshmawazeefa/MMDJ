@extends('layouts.vertical', ["page_title"=> "Sales Return | List"])
            ...
            <div class="page-title-box">
                <div class="page-title-right">
                    <ol class="breadcrumb m-0">
                        <li class="breadcrumb-item"><a href="javascript: void(0);">Sales Returns</a></li>
                    ...
                    <div class="row mb-0 pb-2 dashed-borderStyle">
                        ...
                        <div class="col-sm-12">
                            <div class="text-sm-end mt-2 mb-2 mt-sm-0">
                                <a href="{{url('admin/salesreturn')}}" class="btn btn-primary waves-effect waves-light"><i
                                        class="mdi mdi-plus-circle me-1"></i> Add Sales Return</a>
                            </div>
                        </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-4">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <input id="sales-returnsearchSubmit" class="btn btn-info" type="button"
                                            value="Search" />  
                                            <input id="sales-orderearchReset" class="btn btn-info" type="button"
                                            value="Reset" />
                                            <input id="sales-returnsearchExport" class="btn btn-info" type="button"
                                            value="Excel Export" />                                                           
                                            </div>
                                        </div>  
                                    </div>
    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            <div class="modal-body-approve p-4">
                <div class="text-center">
                    <i class="dripicons-warning h1 text-warning"></i>
                    <h4 class="mt-2">Do you really want to confirm the Sales Return?</h4>
...
<script type="text/javascript">
    $(document).ready(function () {
        var url = "{{url('admin/sales-return')}}";
        ...
        $(document).on('click', '#sales-returnsearchSubmit', function (e) {
            //e.preventDefault();
            table.ajax.url(url).load();
        });

        $(document).on("click", "#sales-returnsearchExport", function () {
            $('#ExportDownload').hide();
            $('#sales-returnsearchExport').val("Downloading..");
            $("#sales-returnsearchExport").attr("disabled", true);
            var url = "{{url('admin/sales-return/excel')}}";
            ...
            $.ajax({
                ...
                success: function (d) {
                    ...
                    $('#sales-returnsearchExport').val("Excel Export");
                    $("#sales-returnsearchExport").attr("disabled", false);
                    $('#ExportDownload').show();
    ...
    $(".modal-body .text-center button").on("click", function (event) {
        ...
        var u = "{{url('admin/sales-return/close/')}}" + '/' + $("#close-quot").val();
