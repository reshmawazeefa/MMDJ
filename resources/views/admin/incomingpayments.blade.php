@extends('layouts.vertical', ["page_title"=> "Incoming Payment | List"])
            ...
            <div class="page-title-box">
                <div class="page-title-right">
                    <ol class="breadcrumb m-0">
                        <li class="breadcrumb-item"><a href="javascript: void(0);">Incoming Payments</a></li>
                        <li class="breadcrumb-item active">Table</li>
                    </ol>
                </div>
                <h4 class="page-title">Incoming Payments</h4>
            </div>
        </div>
    </div>
    <!-- end page title -->
                    ...
                    <div class="row mb-0 pb-2 dashed-borderStyle">
                        ...
                        <div class="col-sm-12">
                            <div class="text-sm-end mt-2 mb-2 mt-sm-0">
                                <a href="{{url('admin/incoming-payment-create')}}" class="btn btn-primary waves-effect waves-light"><i class="mdi mdi-plus-circle me-1"></i> Add Incoming Payment</a>
                            </div>
                        </div>
                        <form id="sales-orderearchForm" class="form" method="POST" action="{{url('admin/incomingpayment/excel')}}">
                            @csrf
                            <div class="col-lg-12">
                                <div class="row">
                                    <div class="col-lg-4">
                                    ...
                                    <div class="col-lg-4">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <input id="incoming-payment-searchSubmit" class="btn btn-info" type="button"
                                            value="Search" />
                                            <input id="sales-orderearchReset" class="btn btn-info" type="button"
                                            value="Reset" />
                                            <!-- <input id="incoming-paymentsearchExport" class="btn btn-info" type="button"
                                            value="Excel Export" /> -->
    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            <div class="modal-body-approve p-4">
                <div class="text-center">
                    <i class="dripicons-warning h1 text-warning"></i>
                    <h4 class="mt-2">Do you really want to confirm the Incoming Payment?</h4>
...
<script type="text/javascript">
    $(document).ready(function () {
        var url = "{{url('admin/incoming-payment')}}";
        ...
        $(document).on('click', '#incoming-payment-searchSubmit', function (e) {
            //e.preventDefault();
            console.log(url);
            table.ajax.url(url).load();
        });

        $(document).on("click", "#incoming-paymentsearchExport", function () {
            $('#ExportDownload').hide();
            $('#incoming-paymentsearchExport').val("Downloading..");
            $("#incoming-paymentsearchExport").attr("disabled", true);
            var url = "{{url('admin/incomingpayment/excel')}}";
            ...
            $.ajax({
                ...
                success: function (d) {
                    ...
                    $('#incoming-paymentsearchExport').val("Excel Export");
                    $("#incoming-paymentsearchExport").attr("disabled", false);
                    $('#ExportDownload').show();
        ...
        $(".customerSelect").select2({
            ajax: {
                url: "{{ url('admin/ajax/list-incoming-customers') }}",
                type: 'POST',
                dataType: 'json',
                delay: 250,
                data: function (params) {
