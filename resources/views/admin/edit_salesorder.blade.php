@extends('layouts.vertical', ["page_title"=> "Sales Order Edit"])
...
<div class="container-fluid">
    ...
    <div class="row">
        <div class="col-12">
            ...
            @endif -->
            <div class="card">
                <form method="post" class="parsley-examples" action="{{url('admin/sales-order/'.$details->id.'/update')}}">
                    {{csrf_field()}}
...
<div class="col-lg-4">
    ...
    <div class="form-group row" style="display: none;"> 
        ...
        <select required name="bill_to" id="bill_to" class="billtoSelect form-control select2"><option value="{{$details->add_type_bill_to}}">{{$details->add_type_bill_to}}</option>
        </select>
        </div>
        <div class="col-sm-6">
        <label for="referral" class="form-label">Ship To: 
        </label>
        <select required name="ship_to" id="ship_to" class="shiptoSelect form-control select2"><option value="{{$details->add_type_ship_to}}">{{$details->add_type_ship_to}}</option>
        </select>
        </div>
        </div>
        </div>
...
<div class="col-lg-4">
    ...
    <div class="form-group row" style="display: none;">
        ...
        <div class="col-sm-7">
        <select name="tax_type" class="tax_typeSelect form-control select2" >
