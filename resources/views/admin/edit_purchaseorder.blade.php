@extends('layouts.vertical', ["page_title"=> "Purchase Edit"])
...
<div class="container-fluid">
                ...
                <div class="page-title-right">
                    <ol class="breadcrumb m-0">
                        <li class="breadcrumb-item">
                            <a href="{{url('admin/sales-order')}}">{{$details->obj_type}} </a></li>
                        <li class="breadcrumb-item active">Edit</li>
                    </ol>
                </div>
                <h4 class="page-title">Edit {{$details->obj_type}} </h4>
                 @if(!empty($errors->all()))
    ...
    <div class="row">
        <div class="col-12">
            ...
            @endif -->
            <div class="card">
                <form method="post" class="parsley-examples" action="{{url('admin/purchase-order/'.$details->id.'/update')}}">
                    {{csrf_field()}}
...
@endif
    <div class="form-group row" style="display: none;">
        ...
        <input type="hidden" class="form-control" name="type" value="{{$details->obj_type}}">
...
@if($details->obj_type=='Purchase Order')
    ...
    <div class="form-group row" style="display: none;">
        ...
        <div class="col-sm-7">
            <input  type="text" name="posting_date"  class="form-control flatpickr-input active" value="{{$details->posting_date}}" readonly>
        </div>
    </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="colbor col-xl-3 col-lg-4 col-md-4 col-sm-5 col-10">
                                            <div class="ech-td">
                                                ...
                                                <!-- <select id="product_{{$i}}" onChange="load_warehouse({{$i}})" required  name="product[]" class="product_{{$i}} itemSelect form-control select2">
                                                    <option value="{{$val->products->productCode??0}}">{{$val->products->productName??0}}</option>
                                                </select> -->
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="colbor col-xl-2 col-lg-3 col-md-3 col-sm-4 col-12">
                                            <div class="ech-td">
                                                ...
                                                <div class="td-value">
                                                <!-- <input min="1" type="number"   id="quantity_{{$i}}" required class="quantity_{{$i}} form-control" onChange="price_calc({{$i}})" name="quantity[]" value="{{$val->qty}}">

                                                <input min="1" type="hidden" id="pquantity_{{$i}}" required class="pquantity_{{$i}} form-control" onkeyup="price_calc({{$i}})" name="pquantity[]" value="{{$val->qty}}">
                                             -->
                                                </div>
                                            </div>
                                        </div> 
                                        ...
                                        <div class="colbor col-xl-4 col-lg-4 col-md-4 col-sm-5 col-10" style="display: none;">
                                            <div class="ech-td" >
    ...
    <div class="row">
        ...
        <div class="col-sm-4">
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-7">
                <input type="number"  step="0.01"  name="grand_total" id="grand_total" class="form-control"  value="{{$details->total}}">
                </div>
            </div>
        </div>    
    <div class="col-sm-4">
                                ...
                                +'<div class="row">'
                                    ...
                                    +'<div class="colbor col-xl-2 col-lg-3 col-md-3 col-sm-4 col-12">'
                                        +'<div class="ech-td">'
                                            ...
                                            +'<div class="td-value"><input min="1" type="number"   id="quantity_'+val+'" required class="quantity_'+val+' form-control" onChange="price_calc('+val+')" name="quantity[]">'
                                            +'<input min="1" type="hidden" id="pquantity_'+val+'" required class="pquantity_'+val+' form-control" onkeyup="price_calc'+val+'" name="pquantity[]"></div></div></div>' 
                                    +'<div class="colbor col-xl-2 col-lg-4 col-md-4 col-sm-8 col-12">'
                                        +'<div class="ech-td">'
...
$(document).on('click', '.remove-row', function(e) {
    ...
    // AJAX call for closing the Purchase Order item
    $.ajax({
