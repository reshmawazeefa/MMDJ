@extends('layouts.vertical', ["page_title"=> "Stock In | List"])
            ...
            <div class="page-title-box">
                <div class="page-title-right">
                    <ol class="breadcrumb m-0">
                        <li class="breadcrumb-item"><a href="javascript: void(0);">Stock In</a></li>
                    ...
                    <div class="row mb-1 pb-2 dashed-borderStyle">
                        ...
                        <div class="col-sm-12">
                            <div class="text-sm-end mt-2 mb-2 mt-sm-0">
                                <a href="{{url('admin/stockin')}}" class="btn btn-primary waves-effect waves-light"><i
                                        class="mdi mdi-plus-circle me-1"></i> Add Stock In</a>
                            </div>
                        </div>
                        <form id="stock-insearchForm" class="form" method="POST" action="{{url('admin/stockin/excel')}}">
                            @csrf
                            <div class="col-lg-12">
                                <div class="row">
                                    <div class="col-lg-4">
                                    ...
                                    <div class="col-lg-4">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <input id="stock-insearchSubmit" class="btn btn-info" type="button"
                                            value="Search" />
                                            <input id="sales-orderearchReset" class="btn btn-info" type="button"
                                            value="Reset" />
                                            <input id="stock-insearchExport" class="btn btn-info" type="button"
                                                value="Excel Export" />
                                            </div>
                                        </div>
                                    </div>
...
<script type="text/javascript">
    $(document).ready(function () {
        ...
        var table = $('#server-datatable').DataTable({
            ...
            columns: [
                ...
                { data: 'from_branch_name', name: 'from_branch_name', defaultContent: '' },
        ...
        $(document).on('click', '#stock-insearchSubmit', function (e) {
            //e.preventDefault();
            table.ajax.url(url).load();
        });

        $(document).on("click", "#stock-insearchExport", function () {
            $('#ExportDownload').hide();
            $('#stock-insearchExport').val("Downloading..");
            $("#stock-insearchExport").attr("disabled", true);
            var url = "{{url('admin/stockin/excel')}}";
            ...
            $.ajax({
                ...
                success: function (d) {
                    ...
                    $('#stock-insearchExport').val("Excel Export");
                    $("#stock-insearchExport").attr("disabled", false);
                    $('#ExportDownload').show();
    ...
    $(".modal-body .text-center button").on("click", function (event) {
        ...
        var u = "{{url('admin/stockin/close/')}}" + '/' + $("#close-quot").val();
