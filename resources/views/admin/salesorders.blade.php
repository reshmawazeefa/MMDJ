@extends('layouts.vertical', ["page_title"=> "Sales Order | List"])
...
<div class="container-fluid">
            ...
            <div class="page-title-box">
                <div class="page-title-right">
                    <ol class="breadcrumb m-0">
                        <li class="breadcrumb-item"><a href="{{url('admin/sales-order')}}">Sales Orders</a></li>
    ...
    <div class="row">
        ...
        <div class="col-12">
            <div class="card">
                <div class="card-body body-style productMStyle table-spcl2 without-button salesorder-bttn neww">
                    <div class="row mb-0 pb-2 dashed-borderStyle">
                        ...
                        <div class="col-sm-12">
                            <div class="text-sm-end mt-2 mb-2 mt-sm-0">
                                <a href="{{url('admin/salesorder')}}" class="btn btn-primary waves-effect waves-light"><i
                                        class="mdi mdi-plus-circle me-1"></i> Add Sales Order</a>
                            </div>
                        </div>
                        <form id="sales-orderearchForm" class="form" method="POST" action="{{url('admin/sales-order/excel')}}">
                            ...
                            <div class="col-lg-12">
                                <div class="row">
                                    ...
                                    <div class="col-lg-4">
                                        <div class="form-group row">
                                            <label for="from-date" class="col-sm-5 col-form-label">
                                            From date
                                            </label>
                                            <div class="col-sm-7">
                                        ...
                                        <div class="form-group row">
                                            <label for="to-date" class="col-sm-5 col-form-label">
                                            To date
                                            </label>
                                            <div class="col-sm-7">
                                         ...
                                         <div class="form-group row">
                                            ...
                                            <div class="col-sm-7">
                                                 <select name="sodoc_num" class="sodocSelect form-control select2">
                                                </select>
                                            </div>
                                        </div> 
                                    </div>
                                    <div class="col-lg-4">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <input id="sales-orderearchSubmit" class="btn btn-info" type="button" value="Search" />
                                            <input id="sales-orderearchReset" class="btn btn-info" type="button" value="Reset" />
                                            <!-- <input id="sales-orderearchExport" class="btn btn-info" type="button" value="Excel Export" /> -->
...
<script type="text/javascript">
    $(document).ready(function () {
        ...
        var table = $('#server-datatable').DataTable({
            ...
            ajax: {
                ...
                data: function (d) {
                    ...
                    d.sodoc_num = $('select[name="sodoc_num"]').val();
            ...
            columns: [
                ...
                { data: 'action', name: 'action', orderable: false }, // Exclude this from export
            ],
            dom: 'Blfrtip',
        ...
        $(document).on("click", "#sales-orderearchExport", function () {
            $('#ExportDownload').hide();
            $('#sales-orderearchExport').val("Downloading..");
            $("#sales-orderearchExport").attr("disabled", true);
            var url = "{{url('admin/sales-order/excel')}}";
            ...
            $.ajax({
                ...
                data:  {
                        ...
                        'sodoc_num' : $('select[name="sodoc_num"]').val(),
                        'stsval':stsval,
                ...
                success: function (d) {
                    ...
                    $('#sales-orderearchExport').val("Excel Export");
                    $("#sales-orderearchExport").attr("disabled", false);
                    $('#ExportDownload').show();
        ...
        $("#sales-orderearchReset").click(function () {
            ...
            $(".sodocSelect").val('').trigger('change');
         ...
         $(".sodocSelect").select2({
            ajax: {
                        url: "{{ url('admin/ajax/sodocSelect') }}",
                        type: 'POST',
                                dataType: 'json',
                                delay: 250,
    ...
    $(".modal-body .text-center button").on("click", function (event) {
        ...
        var u = "{{url('admin/sales-order/close/')}}" + '/' + $("#close-quot").val();
