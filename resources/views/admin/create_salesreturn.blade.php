...
<div class="container-fluid">
    ...
    <div class="row">
        <div class="col-12">@if(!empty($errors->all()))
            ...
            @endif
            <div class="card">
                <form id="sales-order-submit" method="post" class="parsley-examples" action="{{url('admin/salesreturn/insert')}}">
                    {{csrf_field()}}
    ...
    <div class="form-group row">
        ...
        <div class="col-sm-12">
            <div class="row">
                ...
                <div class="col-sm-6">
                <textarea class="form-control" name="ship_to_address" id="ship_to_address"></textarea>
                </div>
            </div>
...
<div class="col-lg-4">
    ...
    <div class="form-group row">
        ...
        <div class="input-group">
            <span class="input-group-text" id="basic-addon1"><select name="doc_list" id="doc_list" class="doc_listSelect form-control select2">
                <option value="TRKABH" selected>TRKABH</option>
            </select></span>
    ...
    <div class="form-group row">
        ...
        <div class="col-sm-7">
        <input required type="date" name="docdue_date" id="docdue_date"  class="form-control flatpickr-input active">
        </div>
    </div>
</div>
...
<div class="row">
    <div class="col-sm-4">
        ...
        <div class="form-group row">
            <label for="referral" class="col-sm-5 col-form-label">
                Reason for Return <span class="text-danger">*</span></label>
            <div class="col-sm-7">
            <select name="return_reason" id="return_reason" class="statusSelect form-control select2" required>
                ...
                <option value="Colour Exchange">Colour Exchange</option>
                <option value="Model Exchange">Model Exchange</option>
                <option value="Gift Product Exchange">Gift Product Exchange</option>
        ...
        <div class="form-group row">
            <label for="referral" class="col-sm-5 col-form-label">
                Type of Damage<span class="text-danger">*</span></label>
            <div class="col-sm-7">
            <select name="damage" id="damage" class="statusSelect form-control select2" required> 
                <option value="">Select</option>
                <option value="Stitching Complaints">Stitching Complaints</option>
                <option value="Pasting Complaints">Pasting Complaints</option>
                <option value="Leather Complaints">Leather Complaints</option>
                <option value="Colour Fade">Colour Fade</option>
                <option value="Sole Damage">Sole Damage</option>
                <option value="Fitting Complaints">Fitting Complaints</option>
                <option value="Logo Complaints">Logo Complaints</option>
                <option value="Nail Complaints">Nail Complaints</option>
                <option value="Insole Complaints">Insole Complaints</option>
                <option value="Zip Complaints">Zip Complaints</option>
                <option value="Buckle Complaints">Buckle Complaints</option>
                <option value="Leather Peel Off">Leather Peel Off</option>
            </select>
            </div>
        </div>
...
<script>
    $(document).ready(function() {
        ...
        $.ajax({
           type:'POST',
           url:"{{ url('admin/code') }}",
           data:{_token: "{{ csrf_token() }}",type:'salesreturn'},
           success:function(data){
    ...
    // Trigger the change event on page load to set the default value
        ...
        $(".customerSelect").select2({
            ajax: {
            url: "{{ url('admin/ajax/salesinvoice-customers') }}",
            type: 'POST',
                    dataType: 'json',
                    delay: 250,
    ...
    $.ajax({
        ...
        success: function(data) {
            ...
            if (data.success) {
                ...
                // window.location.href = 'sales-return/' + data.salesreturn_id;
        ...
        $.ajax({
            ...
            success: function(response) {
                ...
                if (response) {
                    ...
                    console.log(response.salesinvoice);
                    if(salesinvoice!="")
                    {
        ...
        $("#copy_from_qutn").click(function(e) {
            ...
            $.ajax({
                ...
                success: function(data) { // Change 'quotation' to 'data' here
                    ...
                    $('#open_qutn').empty().append('<option disabled>Select a Invoice</option>');
                    ...
                    if (data.length > 0) {
                        ...
                        $('#open_qutn').append('<option value="">Open Invoice is not available</option>');
                    }
                },
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="colbor col-xl-3 col-lg-4 col-md-4 col-sm-5 col-10">
                                            <div class="ech-td">
                                                ...
                                                <div class="td-value">
                                                    <input  type="hidden" id="invoice_item_id_${i}" required class="invoice_item_id_${i} form-control" value="${item.itemid}"  name="invoice_item_id[]">
