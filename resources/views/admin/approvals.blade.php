            ...
            <div class="page-title-box">
                <div class="page-title-right">
                    <ol class="breadcrumb m-0">
                        <li class="breadcrumb-item"><a href="javascript: void(0);">Approval List</a></li>
                        <li class="breadcrumb-item active">Table</li>
                    </ol>
                </div>
                <h4 class="page-title">Approval List</h4>
            </div>
        </div>
    </div>
    <!-- end page title -->
                ...
                <div class="row mb-0 pb-2 dashed-borderStyle">
                    ...
                    <div class="col-sm-12">
                        <div class="text-sm-end mt-2 mb-2 mt-sm-0">
                            <a href="{{url('admin/quote')}}" class="btn btn-primary waves-effect waves-light"><i class="mdi mdi-plus-circle me-1"></i> Add Quotation</a>
                        </div>
                    </div>
                                ...
                                <div class="col-lg-4">
                                    <div class="form-group row">
                                        <div class="col-sm-12" style="text-align:end;">
                                            <input id="quotationSearchSubmit" class="btn btn-info col-sm-5" type="submit" value="Search" />
                                            <input id="quotationSearchReset" class="btn btn-info col-sm-5" type="button" value="Reset" />
                                        </div>
                                    </div>
                                </div>
                            </div>
...
<script type="text/javascript">
  $(document).ready(function() {
    var url = "{{url('admin/approvals/'.$status)}}";
    ...
    $(".modal-body .text-center button").on("click", function (event) {
        ...
        if ($button[0].id == "confirm-close") {
            ...
            var url = "{{url('admin/approval/list')}}";
            var table = $('#server-datatable').DataTable();
            table.ajax.url(url).load();
        }
        else
    ...
    $(".modal-body-approve .text-center button").on("click", function (event) {
        var $button = $(event.target);
        var u = "{{url('admin/quotations/approve/')}}"+'/'+$("#approve-quot").val();
