@extends('layouts.vertical', ["page_title"=> "Purchase Return Edit"])
...
<div class="container-fluid">
                ...
                <div class="page-title-right">
                    <ol class="breadcrumb m-0">
                        <li class="breadcrumb-item">
                            <a href="{{url('admin/sales-order')}}">Purchase Return</a></li>
    ...
    <div class="row">
        <div class="col-12">@if(!empty($errors->all()))
            ...
            @endif
            <div class="card">
                <form method="post" class="parsley-examples" action="{{url('admin/purchase-return/'.$details->id.'/update')}}">
                    {{csrf_field()}}
                    <div class="card-body">
                        <div class="row mb-2">
                            <div class="col-lg-12">
                                <div class="row">
                                    ...
                                    <div class="col-lg-4 col-sm-6">
                                        <div class="me-3">
                                            ...
                                            <select required name="customer" id="customer" class="customerSelect form-control select2" readonly><option value="{{$details->customer->customer_code}}">{{$details->customer->name}}</option>
                                            </select>
                                        </div>
                                    </div>
                                    <div class="col-lg-4 col-sm-6">
                                     ...
                                     <!-- <div class="col-lg-4 col-sm-6">
                                        <div class="me-3">
                                            <label for="referral" class="form-label">Address Type  </label></br>
                                            Bill To : <select required name="bill_to" id="bill_to" class="billtoSelect form-control select2"><option value="{{$details->add_type_bill_to}}">{{$details->add_type_bill_to}}</option>
                                            </select>
                                            Ship To : <select required name="ship_to" id="ship_to" class="shiptoSelect form-control select2"><option value="{{$details->add_type_ship_to}}">{{$details->add_type_ship_to}}</option>
                                            </select>
                                        </div>
                                    </div> -->
                                    <div class="col-lg-4 col-sm-6">
                                    ...
                                    <div class="col-lg-4 col-sm-6">
                                        ...
                                        <div class="col-lg-4 col-sm-6">
                                            <a class="btn btn-primary waves-effect waves-light" id="copy_from_qutn" name="copy_from_qutn">Copy from Purchase Invoice</a>
                                        </div>

                                        <div class="col-lg-4 col-sm-6" id="open_quotation">
                                            <div class="me-3">
                                                <label for="referral" class="form-label">Open Purchase Invoice </label>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="colbor col-xl-3 col-lg-4 col-md-4 col-sm-5 col-10">
                                            <div class="ech-td">
                                                ...
                                                <input type="number" id="unitprice_{{$i}}" required class="unitprice_{{$i}} form-control" onkeyup="price_calc({{$i}})" name="unitprice[]" value="{{$val->unit_price}}">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="colbor col-xl-3 col-lg-4 col-md-4 col-sm-5 col-10">
                                                <div class="ech-td">
                                                    ...
                                                    <div class="td-value">
                                                        <input type="number" id="discprice_{{$i}}" required class="discprice_{{$i}} form-control"  onkeyup="hiddenprice_calc({{$i}})" name="discprice[]" value="{{$val->disc_price}}">
                                                    </div>
                                        ...
                                        <div class="colbor col-xl-2 col-lg-2 col-md-2 col-sm-4 col-6">
                                            <div class="ech-td">
                                                ...
                                                <input type="number" id="linetotal_{{$i}}"  class="linetotal linetotal_{{$i}} form-control" name="linetotal[]" value="{{$val->line_total}}" readonly>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="colbor col-xl-3 col-lg-4 col-md-4 col-sm-5 col-10">
...
@endif
                    ...
                    <div class="specarea">
                        ...
                        <ul>
                            ...
                            <li> <input type="number" name="total_bef_discount" id="total_bef_discount" readonly value="{{$details->total_bf_discount}}"></li>
                        </ul>
                        <ul>
                            <li>
                                <h6>Discount 
                                    <input type="number" name="discount" id="discount" style="width: 45%;" placeholder="0.00" onkeyup="calculate_footer();" value="{{$details->discount_percent}}"> %
                                </h6>
                            </li>
                            <li>
                                <p id="discount_amount">
                                    <input type="number" name="discount_amount_value" id="discount_amount_value" class="form-control" onkeyup="calculate_footerdiscount(this.value);" value="{{$details->discount_amount}}">
                                </p>
                            </li>
                        </ul>
                        <ul>
                            <li><h6>Extra Expense</h6></li>
                            <li><p id="expenses"><input type="number" name="expense" onkeyup="calculate_footer();" id="expense" class="form-control" value="{{$details->total_exp}}"></p></li>
                        </ul>
                        <ul>
                            <li><h6>Tax Amount</h6></li>
                            <li><p id="tax_amount_p"></p><input type="number" name="tax_amount" id="tax_amount" readonly value="{{$details->tax_amount}}"></li>
                        </ul>
                        ...
                        <ul>
                            ...
                            <li><p id="rounding"><input type="number" name="roundtext" onkeyup="calculate_footer();" id="roundtext" class="form-control"  @if($details->rounding != "") style="display: block;" @else style="display: none;" @endif value="{{$details->rounding}}"></p></li>
                        </ul>
                        
                        <ul>
                            <li><h6>Total</h6></li>
                            <li><p id="grand_total_p"></p><input type="number" name="grand_total" id="grand_total" readonly value="{{$details->total}}"></li>
                        </ul>
                    </div>
                    <div>&nbsp;</div>
                            ...
                            +'<div class="echtr-inn">'
                                +'<div class="row">'
                                    ...
                                    +'<div class="colbor col-xl-3 col-lg-3 col-md-3 col-sm-4 col-6">'
                                        +'<div class="ech-td">'
                                            +'<label class="td-label">Unit Price</label>'
                                            +'<div class="td-value"><input min="1" type="number" id="unitprice" required class="unitprice_'+val+' form-control" onkeyup="price_calc('+val+')" name="unitprice[]"></div></div></div>' 
                                            +'<div class="colbor col-xl-3 col-lg-4 col-md-4 col-sm-5 col-10">'
                                            +'<div class="ech-td">'
                                                +'<label class="td-label">Discount Price</label>'
                                                +'<div class="td-value"><input type="number" id="discprice_'+val+'" required class="discprice_'+val+' form-control"  onkeyup="hiddenprice_calc('+val+')" name="discprice[]"></div></div></div>'
                                    ...
                                    +'<div class="colbor col-xl-3 col-lg-3 col-md-3 col-sm-4 col-6">'
                                        +'<div class="ech-td">'
                                            +'<label class="td-label">Line Total</label>'
                                            +'<div class="td-value"><input type="number" id="linetotal_'+val+'"  class="linetotal linetotal_'+val+' form-control" name="linetotal[]" readonly></div></div></div>'
                                    +'<div class="colbor col-xl-3 col-lg-3 col-md-3 col-sm-4 col-6">'
                                        +'<div class="ech-td">'
                                            +'<label class="td-label">Serial No</label>'
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="colbor col-xl-3 col-lg-4 col-md-4 col-sm-5 col-10">
                                            <div class="ech-td">
                                                <label class="td-label">Unit Price</label>
                                                <div class="td-value">
                                                    <input type="number" id="unitprice_${i}" required class="unitprice_${i} form-control" value="${item.UnitPrice}" onkeyup="price_calc(${i})" name="unitprice[]">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="colbor col-xl-3 col-lg-4 col-md-4 col-sm-5 col-10">
                                            <div class="ech-td">
                                                <label class="td-label">Discount Price</label>
                                                <div class="td-value">
                                                    <input type="number" id="discprice_${i}" required class="discprice_${i} form-control"  value="${item.UnitPrice}"onkeyup="hiddenprice_calc(${i})" name="discprice[]">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="colbor col-xl-3 col-lg-4 col-md-4 col-sm-5 col-10">
                                        ...
                                        <div class="colbor col-xl-2 col-lg-2 col-md-2 col-sm-4 col-6">
                                            <div class="ech-td">
                                                ...
                                                <div class="td-value">
                                                    ...
                                                    <input type="number" id="linetotal_${i}" class="linetotal linetotal_${i} form-control" name="linetotal[]" readonly="" value="${item.LineTotal}">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="colbor col-xl-3 col-lg-4 col-md-4 col-sm-5 col-10">
