...
.print-margin {
    ...
    <a class="print_button btn btn-primary" style="margin-left: -10%;" href="{{ url('admin/sales-order/' . $data->id) }}">
        Back
    </a>
...
<h1 style="width:98%; text-align:center; padding:1%; background:#FFF; margin-bottom: 23px; border:1px solid #000;
		margin-top: -23px; font-size:18px; margin-top:10px;"> SALES ORDER</h1>
...
<table class="table" style="margin-bottom: 13px; border:1px solid #000!important;">
                        <tbody>
                            <tr class="add">
                                ...
                                <td style="font-weight: 600;text-transform: uppercase;">Order Details</td>
                            </tr>
                            <tr class="content">
