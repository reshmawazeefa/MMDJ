                ...
                <div class="page-title-right">
                    <ol class="breadcrumb m-0">
                        <li class="breadcrumb-item">
                            <a href="{{url('admin/goods_receipt_po')}}">Purchase Order</a></li>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-lg-4">
                                ...
                                <!-- <div class="form-group row">
                                    ...
                                    <div class="col-sm-7">
                                    <input required  type="text" class="form-control" name="refno" placeholder="Supplier Ref No." aria-describedby="basic-addon1">
                                    </div>
                                </div> -->
                                    <input   type="hidden" class="form-control" name="type" value="Purchase Order">
...
<div class="row" >
    <div class="col-sm-4" >
        ...
        <div class="form-group row">
            <label for="referral" class="col-sm-5 col-form-label">Remarks <span class="text-danger">*</span></label>
            <div class="col-sm-7">
            <textarea placeholder="Remarks" id="remarks" type="text" name="remarks" class="form-control" required></textarea>
            </div>
        </div>
    ...
    <div class="col-sm-4">
         <div class="form-group row">
            <label for="reffer" class="col-sm-6 col-form-label">Total <span class="text-danger">*</span></label>
            <div class="col-sm-6">
