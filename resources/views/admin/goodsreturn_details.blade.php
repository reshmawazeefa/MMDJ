@extends('layouts.vertical', ["page_title"=> "Goods Return Details"])
@section('css')
<!-- third party css -->
            ...
            <div class="page-title-box">
                <div class="page-title-right">
                    <ol class="breadcrumb m-0">
                        <li class="breadcrumb-item"><a href="javascript: void(0);">Goods Return</a></li>
                        <li class="breadcrumb-item active">Goods Return Details</li>
                    </ol>
                </div>
                <h4 class="page-title">Goods Return Details</h4>
            </div>
        </div>
...
<!--  -->
    ...
    <div class="col-sm-4">
        ...
        <!-- <div class="form-group row">
            ...
            <input type="text" name="roundtext" onkeyup="calculate_footer();" id="roundtext" class="form-control" readonly style="background-color: #ebebeb;
