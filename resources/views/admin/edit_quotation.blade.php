...
<div class="container-fluid">
    ...
    <div class="row">
                        ...
                        <div class="row mb-3">
                            <div class="col-lg-4">
                                    <div class="form-group row">
                                        ...
                                        <label for="customer" class="col-sm-5 form-label">Customer <span class="text-danger">*</span>
                                    ...
                                    <div class="form-group row">
                                            ...
                                            <label for="referral" class="col-sm-5 form-label">Referral(Engineer)
                                            <a href="javascript:void(0);"  data-bs-toggle="modal" data-bs-target="#addPartModal"><i class="mdi mdi-plus-circle me-1"></i>Add</a></label>
                                            <div class="col-sm-7"><select name="partner1" class="engineerSelect form-control select2">
                                    ...
                                    <div class="form-group row">
                                            ...
                                            <label for="referral" class="col-sm-5 form-label">Referral(Contractor) <span class="text-danger">*</span></label>
                                             <div class="col-sm-7"><select required name="partner2" class="contractorSelect form-control select2">
                            ...
                            <div class="col-lg-4">
                                    <div class="form-group row">
                                            ...
                                            <label for="referral" class="col-sm-5 form-label">Referral(Sales Executive) <span class="text-danger">*</span></label>
                                                <div class="col-sm-7"><select required name="partner3" class="agentSelect form-control select2">
                                    ...
                                    <div class="form-group row">
                                            ...
                                            <label for="date" class="col-sm-5 form-label">Date <span class="text-danger">*</span></label>
                                           <div class="col-sm-7"> <input required type="date" name="date" value="{{$details->DocDate}}" class="form-control flatpickr-input active" readonly="readonly">
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        
                                            <label for="date" class="col-sm-5 form-label">Due Date <span class="text-danger">*</span></label>
                                            <div class="col-sm-7"><input required type="date" name="DueDate" value="{{$details->DueDate}}" class="form-control flatpickr-input active">
                                        </div>
                                    </div>
                            ...
                            <div class="col-lg-4">
                                    ...
                                    <div class="form-group row">
                                            ...
                                            <label for="referral" class="col-sm-5 form-label">Price List <span class="text-danger">*</span></label>
                                             <div class="col-sm-7">
                                    ...
                                    <div class="form-group row">
                                            ...
                                            <label for="referral" class="col-sm-5 form-label">Vehicle type <span class="text-danger">*</span></label>
                                            <div class="col-sm-7">
                                    ...
                                    <div class="form-group row">
                                            <label for="distance" class="col-sm-5 form-label">Distance(in km)<span class="text-danger"> @if($details->VehType != "N/A") * @endif</span></label>
                                            <div class="col-sm-7">
                                ...
                                <div class="row">
                                    ...
                                    <div class="colbor col-xl-3 col-lg-3 col-md-3 col-sm-4 col-6">
                                        <div class="ech-td">
                                            ...
                                            <div class="td-value">
                                            <input min="1" type="number" id="quantity_{{$i}}" required value="{{$val->Qty}}" class="quantity_{{$i}} form-control" onChange="price_calc_edit({{$i}})" name="quantity[]">
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="colbor col-xl-2 col-lg-2 col-md-3 col-sm-4 col-6">
                                        <div class="ech-td">
                                            ...
                                            <div class="td-value">
                                                <input type="number" @if($val->DiscType == 'Percentage') value="{{$val->LineDiscPrcnt}}" @else value="{{round($val->PerSqftDisc * (100+$val->TaxRate)/100)}}" @endif id="discvalue_{{$i}}" step="0.0001" value="0" class="form-control" onChange="price_calc_edit({{$i}})" name="disc_perct[]">
                                    ...
                                    <div class="colbor col-xl-3 col-lg-2 col-md-2 col-sm-4 col-6">
                                        <div class="ech-td">
        ...
        <div class="col-sm-4">
            <div class="form-group row">
                <label for="posting_date" class="col-sm-5 col-form-label">Total Amount</label>
                <div class="col-sm-7">
                <input type="text" class="form-control" id="total_amount" readonly></imput>
                </div>
            </div>

            <div class="form-group row">
                <label for="referral" class="col-sm-5 col-form-label">Discount</label>
                <div class="col-sm-7">
                <input type="text" id="discount_amount" class="form-control" readonly></imput>
                </div>
            </div>
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-7">
                <input type="text" id="remarks" name="remarks" class="form-control"  value="{{$details->Remarks}}"></imput>
                </div>
            </div>
        </div>
        <div class="col-sm-4">
            <div class="form-group row">
                <label for="reffer" class="col-sm-6 col-form-label">Tax</label>
                <div class="col-sm-6">
                <input type="text" name="tax_amount" class="form-control" id="tax_amount" readonly >
                </div>
            </div>
            <div class="form-group row">
                <label for="reffer" class="col-sm-6 col-form-label">Freight charges 
                </label>
                <div class="col-sm-6" id="freight">
                <input type="number" name="FreightCharge" id="FreightCharge" class="form-control" onChange="calculate_footer();" value="{{$details->FreightCharge}}">
                </div>
            </div>

            <div class="form-group row">
                <label for="reffer" class="col-sm-6 col-form-label">Loading charges</label>
                <div class="col-sm-6" id="LoadingCharge">
                <input type="number" name="LoadingCharge" onChange="calculate_footer();" id="LoadingCharge"  value="{{$details->LoadingCharge}}" class="form-control">
                </div>
            </div>
        </div>
        ...
        <div class="col-sm-4">
            <div class="form-group row">
                <label for="reffer" class="col-sm-6 col-form-label">Unloading charges</label>
                <div class="col-sm-6">
                <input type="number" name="UnloadingCharge" id="UnloadingCharge" class="form-control" readonly value="{{$details->UnloadingCharge}}" onChange="calculate_footer();">
                </div>
            </div>
                                ...
                                +'<div class="row">'
                                    ...
                                    +'<div class="colbor col-xl-3 col-lg-3 col-md-3 col-sm-4 col-6">'
                                        +'<div class="ech-td">'
                                            ...
                                            +'</div>'
                                            +'</div>'
                                            +'<div class="colbor col-xl-3 col-lg-3 col-md-2 col-sm-4 col-6">'
                                            +'<div class="ech-td">'
                                            +'<label class="td-label">On Hand</label>'
                                            +'<div class="td-value">'
                                            +'<input type="hidden" name="warehouse[]" value="VNGW0002">'
