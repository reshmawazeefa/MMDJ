@extends('layouts.vertical', ["page_title"=> "Purchase Invoice Create"])
...
<div class="container-fluid">
                ...
                <div class="page-title-right">
                    <ol class="breadcrumb m-0">
                        <li class="breadcrumb-item">
                            <a href="{{url('admin/purchase_invoice')}}">Purchase Invoice</a></li>
                        <li class="breadcrumb-item active">Create</li>
                    </ol>
                </div>
                <h4 class="page-title">Create Purchase Invoice</h4>
            </div>
        </div>
    </div>
    <!-- end page title -->
    ...
    <div class="row">
        <div class="col-12">@if(!empty($errors->all()))
            ...
            @endif
            <div class="card">
                <form id="purchase-invoice-submit" method="post" class="parsley-examples" action="{{url('admin/purchase-invoice/insert')}}">
                    {{csrf_field()}}
...
<div class="col-lg-4">
    ...
    <div class="form-group row" style="display: none;">
        ...
        <div class="col-sm-7">
        <input type="text" class="form-control" name="refno" id="refno" placeholder="Supplier Ref No."  aria-describedby="basic-addon1">
        </div>
    </div>
...
<div class="col-lg-4">
    ...
    <div class="form-group row" style="display: none;">
        ...
        <div class="col-sm-7">
        <input  type="text" name="posting_date"  class="form-control flatpickr-input active" value="<?php echo date('d-m-Y');?>" readonly>
        </div>
    </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="colbor col-xl-5 col-lg-5 col-md-5 col-sm-5 col-10">
                                        <div class="ech-td">
                                            ...
                                            <div class="td-value">
                                            <input min="1" type="text"    id="total_{{$i}}" required class="total_{{$i}} form-control"  name="total[]">
                                            </div>
                                        </div>
                                    </div>
...
<div class="row">
    <div class="col-sm-4">
        ...
        <div class="form-group row" style="display: none;">
            ...
            <div class="col-sm-7">
            <textarea placeholder="Remarks" id="msg" type="text" name="msg" class="form-control"></textarea>
            </div>
        </div>
...
<script>
    $(document).ready(function() {
        ...
        $.ajax({
           type:'POST',
           url:"{{ url('admin/code') }}",
           data:{_token: "{{ csrf_token() }}",type:'purchaseinvoice'},
           success:function(data){
...
function calculate_footerdiscount(val=0)
{
    ...
    $("#purchase-invoice-submit").submit(function(e){
    ...
    $.ajax({
        ...
        success: function(data) {
            ...
            if (data.success) {
                ...
                // window.location.href = 'purchase_invoice/' + data.purchaseinvoice_id;
                            ...
                            <div class="ech-tr" id="tr_${i}">
                                ...
                                <div class="echtr-inn">
                                    <div class="row">
                                        ...
                                        <div class="colbor col-xl-6 col-lg-5 col-md-5 col-sm-5 col-10">
                                            <div class="ech-td">
                                                <label class="td-label">Remarks</label>
                                                <input  type="hidden" id="quotation_item_id_${i}" required class="quotation_item_id_${i} form-control" value="${item.id}"  name="quotation_item_id[]">
                                                <div class="td-value">
                                                   
                                                    <textarea id="remarks_${i}" required class="remarks_${i} form-control"  name="remarks[]">${item.remarks}</textarea>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="colbor col-xl-5 col-lg-5 col-md-5 col-sm-5 col-10">
                                            <div class="ech-td">
                                                <label class="td-label">Total Amount <span class="text-danger">*</span></label>
                                                <div class="td-value">
                                              <input  type="text" id="linetotal_${i}" required class="linetotal_${i} form-control" value="${item.total}" onChange="calculate_footer();"  name="linetotal[]">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="actn-td">
                                    <a href="javascript:void(0);" class="action-icon delete-item1 remove-row" value="${item.id}"></a>
                                </div>
                            </div>`;
                        // <a href="javascript:void(0);" class="action-icon add-item"></a>
