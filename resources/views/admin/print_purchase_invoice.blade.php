...
<body style="margin: 0;
    ...
    flex-direction: column;">
        ...
        margin-bottom: 15px;">
    <a class="print_button btn btn-primary" href="{{url('admin/purchase_invoice/'.$data->id)}}">Back</a>
      ...
      <div class="main">
      	...
      	<div class="esti-dtls">
      		<div class="estidtls-hed">
      			<div class="estino">
      				<p>Invoice No:<span>{{$data->doc_num}}</span></p>
      			</div>
      			<div class="estidt">
			...
			@if(count($data->Item_details) > 0)
				@foreach ($data->Item_details as $key=>$val)
					...
					<div class="table-tr">
						...
						<div class="table-td tonefull">{{$val->total_amount}}</div>
