                    ...
                    <form id="form" role="form" class="parsley-examples" method="post" action="{{url('admin/customers/'.$customer->id)}}">
                        ...
                        <div class="row mb-3">
                            <div class="col-xl-4 col-lg-6 col-sm-6 md-pt">
                                ...
                                <div class="form-group row">
                                    <label for="hori-pass1" class="col-4 col-form-label">Customer  Code<span class="text-danger">*</span></label>
                                    <div class="col-7">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-3">
                                        <input type="tel" name="country_code" pattern="\d{1,4}" value="{{old('country_code')? old('country_code'):$customer->country_code}}" required placeholder="44" class="form-control" id="country-code" title="Country Code" />
                                    </div>
                                    <div class="col-4">
                        ...
                        <div class="form-group row mt-2 pt-2 mb-2" style="border-top: 1px dashed #ebebeb;">
                            <div class="col-md-7"><input type="checkbox" name="sepBilling" id="sepBilling" @if($customer->same_checking=='on') {{'checked'}} @endif>
