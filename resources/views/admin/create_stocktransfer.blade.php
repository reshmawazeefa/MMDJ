@extends('layouts.vertical', ["page_title"=> "Stock Transfer Request Create"])
...
<div class="container-fluid">
                ...
                <div class="page-title-right">
                    <ol class="breadcrumb m-0">
                        <li class="breadcrumb-item">
                            <a href="{{url('admin/sales-invoice')}}">Stock Transfer Request</a></li>
                        <li class="breadcrumb-item active">Create</li>
                    </ol>
                </div>
                <h4 class="page-title">Create Stock Transfer Request</h4>
            </div>
        </div>
    </div>
    <!-- end page title -->
    ...
    <div class="row">
        <div class="col-12">@if(!empty($errors->all()))
            ...
            @endif
            <div class="card">
                <form method="post" class="parsley-examples" action="{{url('admin/stocktransfer/insert')}}">
                    {{csrf_field()}}
                    <div class="card-body body-style">
                        ...
                        <div class="col-lg-4">
                                ...
                                <div class="form-group row">
                                            ...
                                            <div class="col-sm-6">
                                            <input   type="text" class="form-control" name="from_branch" id="from_branch"  aria-describedby="basic-addon1" value="{{session('branch_name')}}" readonly>
                        ...
                        <div class="col-lg-4">
                                        <div class="form-group row">
                                                ...
                                                <div class="col-sm-6">
                                                <input required type="date" name="posting_date" id="posting_date" class="form-control flatpickr-input active" >
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                    ...
                                    <div class="ech-tr" id="tr_{{$i}}">
                                        ...
                                        <div class="echtr-inn">
                                            <div class="row">
                                                ...
                                                <div class="colbor col-xl-5 col-lg-6 col-md-6 col-sm-7 col-12">
                                                    <div class="ech-td">
                    ...
                    <div class="row">
                        <div class="col-sm-4">
                                <div class="form-group row">
                                        ...
                                        <div class="col-sm-6"><select required name="partner3" class="agentSelect form-control select2">
                                                </select>
                                    </div>
                                </div>
                                ...
                                <div class="form-group row">
                                        ...
                                        <div class="col-sm-6"><textarea placeholder="Remarks" type="text" name="remarks" class="form-control" ></textarea>
...
document.getElementById('to_branch').addEventListener('change', function() {
    ...
    document.getElementById('to_branch_name').value = bname || '';
        ...
        $.ajax({
           type:'POST',
           url:"{{ url('admin/code') }}",
           data:{_token: "{{ csrf_token() }}",type:'stock-transfer-request'},
           success:function(data){
                                            ...
                                            <div class="colbor col-xl-3 col-lg-4 col-md-4 col-sm-5 col-10">
                                                <div class="ech-td">
                                                    ...
                                                    <div class="td-value">
                                                        ...
                                                        <input min="1" type="number" id="quantity_${i}" required class="quantity_${i} form-control" value="1" onChange="price_calc(${i})" name="quantity[]">
                                                    </div>
                                                </div>
                                            </div>
...
$(document).on('click', '.remove-row', function(e) {
    ...
    // AJAX call for closing the Stock Transfer Request item
    $.ajax({
