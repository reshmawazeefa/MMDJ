@extends('layouts.vertical', ["page_title"=> "Sales Order Create"])
...
<div class="container-fluid">
                ...
                <div class="page-title-right">
                    <ol class="breadcrumb m-0">
                        <li class="breadcrumb-item">
                            <a href="{{url('admin/sales-order')}}">Sales Order</a></li>
    ...
    <div class="row">
        <div class="col-12">
            ...
            @endif -->
            <div class="card">
                <form id="sales-order-submit" method="post" class="parsley-examples" action="{{url('admin/salesorder/insert')}}">
                    {{csrf_field()}}
...
<div class="col-lg-4">
    ...
    <div class="form-group row" style="display: none;">
        ...
        <div class="row">
            ...
            <label for="referral" class="form-label">Bill To : 
                ...
                <select required name="bill_to" id="bill_to" class="billtoSelect form-control select2">
            </select>
            </div>
            <div class="col-sm-6">
            <label for="referral" class="form-label">Ship To: 
            </label>
                <select required name="ship_to" id="ship_to" class="shiptoSelect form-control select2">
            </select>
            </div>
        </div>
        </div>
    ...
    <div class="form-group row">
        ...
        <div class="row">
            ...
            <textarea class="form-control" name="bill_to_address" id="bill_to_address" required readonly></textarea>
            </div>
            <div class="col-sm-6">
            <label for="referral" class="form-label">Ship To: 
                </label>
            <textarea class="form-control" name="ship_to_address" id="ship_to_address" required readonly></textarea>
            </div>
        </div>
        </div>
    </div>
...
<div class="col-lg-4">
    <div class="form-group row">
        <label for="referral" class="col-sm-5 col-form-label">Place of Supply <span class="text-danger">*</span></label>
        <div class="col-sm-7">
...
<div class="col-lg-4">
<div class="form-group row">
    <label for="date" class="col-sm-5 col-form-label">Delivery Date <span class="text-danger">*</span></label>
    <div class="col-sm-7">
    <input required type="date" name="delivery_date" id="delivery_date"  class="form-control flatpickr-input active">
    </div>
  </div>
  <div class="form-group row">
    <label for="posting_date" class="col-sm-5 col-form-label">Document Date <span class="text-danger">*</span></label>
    <div class="col-sm-7">
  ...
  <!--<div class="form-group row">
    ...
    <div class="col-sm-7">
    <input  type="text" name="tax_reg_no"  class="form-control">
    </div>
  </div> -->
        ...
        <div class="ech-tr" id="tr_{{$i}}">
            ...
            <div class="echtr-inn">
                <div class="row">
                    ...
                    <div class="colbor col-xl-3 col-lg-4 col-md-4 col-sm-10 col-10">
                        <div class="ech-td">
                    ...
                    <div class="colbor col-xl-2 col-lg-4 col-md-4 col-sm-12 col-12">
                        <div class="ech-td">
                    ...
                    <div class="colbor col-xl-2 col-lg-3 col-md-3 col-sm-7 col-12">
                        <div class="ech-td">
                            ...
                            <input min="0.1" type="hidden" id="av_quantity_{{$i}}" required class="av_quantity_{{$i}} form-control" onkeyup="price_calc({{$i}})" name="av_quantity[]">
                            </div>
                        </div>
                    </div> 
                    ...
                    <div class="colbor col-xl-3 col-lg-4 col-md-4 col-sm-5 col-12" style="display: none;">
                        <div class="ech-td">
                            ...
                            <input type="text"  id="whscode_{{$i}}" class="linetotal whscode_{{$i}} form-control" name="whscode[]" readonly="" >
                            </div>
                        </div>
                    </div>
                    <div class="colbor col-xl-9 col-lg-12 col-md-12 col-sm-12 col-12" >
                        <div class="ech-td">
                    ...
                    <div class="colbor col-xl-9 col-lg-12 col-md-12 col-sm-12 col-12" style="display:none;">
                        <div class="ech-td">
                            <label class="td-label">Line Total</label>
                            <div class="td-value">
                            <!-- <span class="linetotal linetotal_{{$i}}"></span> -->
                            <input type="number" step="0.01" id="dis_linetotal_{{$i}}"  class="linetotal dis_linetotal_{{$i}} form-control" name="dis_linetotal[]" readonly>
                            </div>
                        </div>
                    </div>
...
<div class="row">
    ...
    <div class="col-sm-4">
        <div class="form-group row">
            ...
            <div class="col-sm-6">
            <input type="number" class="form-control" name="total_bef_discount" id="total_bef_discount" step="0.01" readonly>
            </div>
        </div>
        <div class="form-group row">
    ...
    <div class="col-sm-4">
        <div class="form-group row">
            ...
            <div class="col-sm-6">
            <input type="number" step="0.01" class="form-control" name="tax_amount" id="tax_amount" readonly>
            </div>
        </div>

        <div class="form-group row">
            <label for="reffer" class="col-sm-6 col-form-label"><input type="checkbox" id="rounding_check" name="option1" value="value1" style="margin-right:10px;">Rounding</label>
...
<div class="col-12 create-order-btnstyle">
<button type="submit" class="btn btn-primary waves-effect waves-light" style="float: right; margin-bottom:3%;">Save</button>
</div>
...
<script>
    $(document).ready(function() {
        ...
        $('#open_qutn option:first').attr('disabled', true);
        var today = new Date();
        ...
        $.ajax({
           type:'POST',
           url:"{{ url('admin/code') }}",
           data:{_token: "{{ csrf_token() }}",type:'salesorder'},
           success:function(data){
                                ...
                                +'<div class="row">'
                                    ...
                                    +'<div class="colbor col-xl-3 col-lg-4 col-md-4 col-sm-10 col-10">'
                                        +'<div class="ech-td">'
                                            ...
                                            +'<div class="colbor col-xl-2 col-lg-4 col-md-4 col-sm-12 col-12">'
                        +'<div class="ech-td"><label class="td-label">Unit <span class="text-danger">*</span></label><div class="td-value"><span class="unit_{{$i}}"></span><select class="unit_'+val+' form-control unit-select" name="unit[]" id="unit_'+val+'" required></select>'
                            +'</div></div></div>'
                                     
                                    +'<div class="colbor col-xl-2 col-lg-3 col-md-3 col-sm-12 col-12">'
                                        +'<div class="ech-td">'
                                            +'<label class="td-label">Quantity <span class="text-danger">*</span></label>'
                                            +'<div class="td-value"><input min="0.1" step="any" type="number"  id="quantity_'+val+'" required class="quantity_'+val+' form-control" onChange="price_calc('+val+')" name="quantity[]"><input min="0.1" type="hidden" id="av_quantity_'+val+'" required class="av_quantity_'+val+' form-control" onkeyup="price_calc('+val+')" name="av_quantity[]"></div></div></div>' 
                                    +'<div class="colbor col-xl-2 col-lg-4 col-md-4 col-sm-12 col-12">'
                                        +'<div class="ech-td">'
                                            +'<label class="td-label">Unit Price <span class="text-danger">*</span></label>'
                                    ...
                                    +'<div class="colbor col-xl-3 col-lg-4 col-md-4 col-sm-12 col-12">'
                                        +'<div class="ech-td">'
                                            +'<label class="td-label">TaxCode</label>'
                                            +'<div class="td-value"><select class="form-control taxcode-select" id="taxcode_'+val+'" onchange="calculate_footer()" name="taxcode[]" ><option value="0">EXEMPT</option><option value="12" style="display: none;">CSGST@12</option><option value="18" style="display: none;">CSGST@18</option><option value="5" style="display: none;">CSGST@5</option><option value="13" style="display: none;">CSGST@13</option><option value="19" style="display: none;">CSGST@19</option><option value="4" style="display: none;">IGST 4</option><option value="11" style="display: none;">IGST 11</option><option value="17" style="display: none;">IGST 17</option></select> </div></div></div>'
                                    
                                    +'<div class="colbor col-xl-3 col-lg-3 col-md-3 col-sm-4 col-6" style="display: none;">'
                                        +'<div class="ech-td">'
                                            +'<label class="td-label">WHSE <span class="text-danger">*</span></label>'
                                            +'<div class="td-value"><input type="text" id="whscode_'+val+'"  class=" whscode_'+val+' form-control" name="whscode[]" ></div></div></div>'
                                    ...
                                    +'<div class="colbor col-xl-9 col-lg-12 col-md-3 col-sm-4 col-6" style="display :none;">'
                                        +'<div class="ech-td">'
                                            +'<label class="td-label">Line Total</label>'
                                            +'<div class="td-value"><input type="number" step="0.01" id="dis_linetotal_'+val+'"  class="linetotal dis_linetotal_'+val+' form-control" name="dis_linetotal[]" readonly></div></div></div>'
    ...
    var dis_linetotal_id = '.dis_linetotal_' + r;
    ...
    // var disPrice = parseFloat($(discprice_id).val()) || 0;
...
function calculate_footerdiscount(val=0)
{
    ...
    $("#sales-order-submit").submit(function(e){
    //alert("hi");
    var empid=$('#partner3').val();
    if(empid==null)
    {
        // alert("hi");
        $('#partner3').focus();
    ...
    $.ajax({
        ...
        success: function(data) {
            ...
            if (data.success) {
                ...
                // window.location.href = 'sales-order/' + data.salesorder_id;
...
$('#open_qutn').change(function() {
    ...
    if (selectedValue) {
        $.ajax({
            ...
            success: function(response) {
                console.log("Data fetched: "); // Log the response to see the data
                            ...
                            <div class="ech-tr" id="tr_${i}">
                                ...
                                <div class="echtr-inn">
                                    <div class="row">
                                        ...
                                        <div class="colbor col-xl-2 col-lg-3 col-md-2 col-sm-7 col-12">
                                            <div class="ech-td">
                                                <label class="td-label">Quantity <span class="text-danger">*</span></label>
                                                <div class="td-value">
                                        ...
                                        <div class="colbor col-xl-3 col-lg-4 col-md-4 col-sm-7 col-10">
                                            <div class="ech-td">
                                                <label class="td-label">Tax Code</label>
                                                <div class="td-value">
                                                    <select class="form-control taxcode-select" name="taxcode[]" id="taxcode_${i}" onChange="calculate_footer()">
                                        ...
                                        <div class="colbor col-xl-9 col-lg-12 col-md-12 col-sm-12 col-12" style="display:none;">
                                            <div class="ech-td">
                                                <label class="td-label">Line Total</label>
                                                <div class="td-value">
                                                    <input type="number" step="0.01" id="dis_linetotal_${i}" class="dis_linetotal dis_linetotal_${i} form-control" name="dis_linetotal[]" readonly="" value="${item.LineTotal}">
                                                </div>
                                            </div>
                                        </div>
