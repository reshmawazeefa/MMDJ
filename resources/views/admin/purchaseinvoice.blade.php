@extends('layouts.vertical', ["page_title"=> "Purchase Invoice | List"])
                    ...
                    <div class="row mb-0 pb-2 dashed-borderStyle">
                        ...
                        <div class="col-sm-12">
                            <div class="text-sm-end mt-2 mb-2 mt-sm-0">
                                <a href="{{url('admin/purchase_invoice')}}" class="btn btn-primary waves-effect waves-light"><i
                                        class="mdi mdi-plus-circle me-1"></i> Add Purchase Invoice</a>
                            </div>
                        </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-4">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <input id="purchase-invoicesearchSubmit" class="btn btn-info" type="button" value="Search" />
                                            <input id="sales-orderearchReset" class="btn btn-info" type="button" value="Reset" />
                                            <!-- <input id="purchase-invoicesearchExport" class="btn btn-info" type="button" value="Excel Export" /> -->
                                            </div>
                                        </div>
                                    </div>
                                </div>
    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            <div class="modal-body-approve p-4">
                <div class="text-center">
                    <i class="dripicons-warning h1 text-warning"></i>
                    <h4 class="mt-2">Do you really want to confirm the Purchase Invoice?</h4>
...
<script type="text/javascript">
    $(document).ready(function () {
        var url = "{{url('admin/purchase-invoice')}}";
        ...
        $(document).on('click', '#purchase-invoicesearchSubmit', function (e) {
            //e.preventDefault();
            console.log(url);
            table.ajax.url(url).load();
        });

        $(document).on("click", "#purchase-invoicesearchExport", function () {
            $('#ExportDownload').hide();
            $('#purchase-invoicesearchExport').val("Downloading..");
            $("#purchase-invoicesearchExport").attr("disabled", true);
            var url = "{{url('admin/purchase_invoice/excel')}}";
            ...
            $.ajax({
                ...
                success: function (d) {
                    ...
                    $('#purchase-invoicesearchExport').val("Excel Export");
                    $("#purchase-invoicesearchExport").attr("disabled", false);
                    $('#ExportDownload').show();
