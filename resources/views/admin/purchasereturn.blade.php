@extends('layouts.vertical', ["page_title"=> "Purchase Return | List"])
            ...
            <div class="page-title-box">
                <div class="page-title-right">
                    <ol class="breadcrumb m-0">
                        <li class="breadcrumb-item"><a href="javascript: void(0);">Purchase Returns</a></li>
                    ...
                    <div class="row mb-0 pb-2 dashed-borderStyle">
                        ...
                        <div class="col-sm-12">
                            <div class="text-sm-end mt-2 mb-2 mt-sm-0">
                                <a href="{{url('admin/purchase_return')}}" class="btn btn-primary waves-effect waves-light"><i
                                        class="mdi mdi-plus-circle me-1"></i> Add Purchase Return</a>
                            </div>
                        </div>
                        <form id="sales-orderearchForm" class="form" method="POST" action="{{url('admin/purchase-return/excel')}}">
                            @csrf
                            <div class="col-lg-12">
                                <div class="row">
                                    <div class="col-lg-4">
                                    ...
                                    <div class="col-lg-4">
                                        ...
                                        <div class="form-group row">
                                            <div class="col-sm-12" style="text-align:end;">
                                                <input id="purchase-returnsearchSubmit" class="btn btn-info" type="button"
                                                value="Search" />
                                                <input id="sales-orderearchReset" class="btn btn-info" type="button"
                                                value="Reset" />
                                                <!-- <input id="purchase-returnsearchExport" class="btn btn-info" type="button"
                                                value="Excel Export" /> -->
                                            </div>
                                        </div>
                                    </div>
    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            <div class="modal-body-approve p-4">
                <div class="text-center">
                    <i class="dripicons-warning h1 text-warning"></i>
                    <h4 class="mt-2">Do you really want to confirm the Purchase Return?</h4>
...
<script type="text/javascript">
    $(document).ready(function () {
        var url = "{{url('admin/purchase-return')}}";
        ...
        $(document).on('click', '#purchase-returnsearchSubmit', function (e) {
            //e.preventDefault();
            console.log(url);
            table.ajax.url(url).load();
        });

        $(document).on("click", "#purchase-returnsearchExport", function () {
            $('#ExportDownload').hide();
            $('#purchase-returnsearchExport').val("Downloading..");
            $("#purchase-returnsearchExport").attr("disabled", true);
            var url = "{{url('admin/purchase-return/excel')}}";
            ...
            $.ajax({
                ...
                success: function (d) {
                    ...
                    $('#purchase-returnsearchExport').val("Excel Export");
                    $("#purchase-returnsearchExport").attr("disabled", false);
                    $('#ExportDownload').show();
