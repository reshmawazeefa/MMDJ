@extends('layouts.vertical', ["page_title"=> "Stock Tansfer Request Details"])
@section('css')
<!-- third party css -->
            ...
            <div class="page-title-box">
                <div class="page-title-right">
                    <ol class="breadcrumb m-0">
                        <li class="breadcrumb-item"><a href="javascript: void(0);">Stock Tansfer Request</a></li>
                        <li class="breadcrumb-item active">Stock Tansfer Request Details</li>
                    </ol>
                </div>
                <h4 class="page-title">Stock Tansfer Request Details</h4>
            </div>
        </div>
        <!-- <div class="col-lg-12">
            ...
            <div class="widget-rounded-circle card">
                <div class="card-body">
                    <div class="row">
                        ...
                        <div class="col-6">
                            <div class="text-end">
                                <h3 class="text-dark mt-1"><span data-plugin="counterup">{{$details->total_price}}</span></h3>
                    ...
                    <div class="row mb-0 pb-2 dashed-borderStyle">
                        ...
                        <div class="col-lg-4">
                                    ...
                                    <div class="form-group row">
                                                ...
                                                <div class="col-sm-7"><input  readonly type="text" class="form-control" name="status" aria-describedby="basic-addon1" value="@if($details->status) {{$details->status}} @endif">
