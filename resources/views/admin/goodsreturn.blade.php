@extends('layouts.vertical', ["page_title"=> "Goods Return | List"])
            ...
            <div class="page-title-box">
                <div class="page-title-right">
                    <ol class="breadcrumb m-0">
                        <li class="breadcrumb-item"><a href="javascript: void(0);">Goods Returns</a></li>
                        <li class="breadcrumb-item active">Table</li>
                    </ol>
                </div>
                <h4 class="page-title">Goods Returns</h4>
            </div>
        </div>
    </div>
    <!-- end page title -->
                    ...
                    <div class="row mb-0 pb-2 dashed-borderStyle">
                        ...
                        <div class="col-sm-12">
                            <div class="text-sm-end mt-2 mb-2 mt-sm-0">
                                <a href="{{url('admin/goods_return')}}" class="btn btn-primary waves-effect waves-light"><i
                                        class="mdi mdi-plus-circle me-1"></i> Add Goods Return</a>
                            </div>
                        </div>
                                    ...
                                    <div class="col-lg-4">
                                        ...
                                        <div class="form-group row">
                                            <div class="col-sm-12" style="text-align:end;">
                                                <input id="goods-returnsearchSubmit" class="btn btn-info" type="button"
                                                value="Search" />
                                                <input id="sales-orderearchReset" class="btn btn-info" type="button"
                                                value="Reset" />
                                                <input id="goods-returnsearchExport" class="btn btn-info" type="button"
                                                value="Excel Export" />
                                            </div>
                                        </div>
                                    </div>
    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            <div class="modal-body-approve p-4">
                <div class="text-center">
                    <i class="dripicons-warning h1 text-warning"></i>
                    <h4 class="mt-2">Do you really want to confirm the Goods Return?</h4>
...
<script type="text/javascript">
    $(document).ready(function () {
        var url = "{{url('admin/goods-return')}}";
        ...
        $(document).on('click', '#goods-returnsearchSubmit', function (e) {
            //e.preventDefault();
            console.log(url);
            table.ajax.url(url).load();
        });

        $(document).on("click", "#goods-returnsearchExport", function () {
            $('#ExportDownload').hide();
            $('#goods-returnsearchExport').val("Downloading..");
            $("#goods-returnsearchExport").attr("disabled", true);
            var url = "{{url('admin/goods-return/excel')}}";
            ...
            $.ajax({
                ...
                success: function (d) {
                    ...
                    $('#goods-returnsearchExport').val("Excel Export");
                    $("#goods-returnsearchExport").attr("disabled", false);
                    $('#ExportDownload').show();
