@extends('layouts.vertical', ["page_title"=> "Goods Receipt PO Create"])
...
<div class="container-fluid">
                ...
                <div class="page-title-right">
                    <ol class="breadcrumb m-0">
                        <li class="breadcrumb-item">
                            <a href="{{url('admin/goods_receipt_po')}}">Other Expenses</a></li>
                        <li class="breadcrumb-item active">Create</li>
                    </ol>
                </div>
                <h4 class="page-title">Create Other Expenses</h4>
                @if(!empty($errors->all()))
    ...
    <div class="row">
        <div class="col-12">
            ...
            @endif -->
            <div class="card">
                <form id="purchase-order-submit" method="post" class="parsley-examples" action="{{url('admin/goods-receipt-po/insert')}}">
                    {{csrf_field()}}
                    <div class="card-body body-style">
                        <div class="row mb-3">

                            <div class="col-lg-4">
                               <!-- 🟢 Supplier or Miscellaneous Switch -->
                                <div class="form-group row mb-3" style="display: none;">
                                    <label class="col-sm-5 col-form-label">Select Type <span class="text-danger">*</span></label>
                                    <div class="col-sm-7 d-flex gap-3">
                                        <div>
                                            <input type="radio" name="extype" id="supplierOption" value="supplier" checked>
                                            <label for="supplierOption">Supplier</label>
                                        </div>
                                        <div>
                                            <input type="radio" name="extype" id="miscOption" value="misc">
                                            <label for="miscOption">Miscellaneous</label>
                                        </div>
                                    </div>
                                </div>

                                <!-- 🟢 Supplier Dropdown (Hidden based on selection) -->
                                <div id="supplierSelectBox" class="form-group row" style="display: none;">
                                ...
                                <input type="hidden" class="form-control" name="type" value="Other Expense">
                        ...
                        <div class="col-lg-4">
                            ...
                            <div class="form-group row" style="display: none;">
                              ...
                              <div class="form-group row">
                                    ...
                                    <div class="col-sm-7">
                                    <input required type="text" name="inv_no" id="inv_no"  class="form-control flatpickr-input active">
                                    </div>
                                </div>
                        ...
                        <div class="col-lg-4">
                            ...
                            <div class="form-group row" style="display: none;"> 
                                ...
                                <div class="col-sm-7">
                                <input required type="text" name="DocuDate" class="form-control flatpickr-input active" value="<?php echo date('d-m-Y');?>">
                                </div>
                            </div>
                            ...
                            <!-- <div class="form-group row">
                                ...
                                <div class="col-sm-7">
                                <input required type="text" id="tax_reg_no" name="tax_reg_no"  class="form-control">
                                </div>
                            </div> -->

                            <!-- <div class="form-group row">
                            <div class="col-sm-12 mt-1">
                                <a class="btn btn-primary waves-effect waves-light mb-0 qutt-bttn" id="copy_from_qutn" name="copy_from_qutn">Copy from Sales Invoice</a>
                                </div>
                            ...
                            <div class="echtr-inn">
                                <div class="row">
                                    ...
                                    <div class="colbor col-xl-9 col-lg-12 col-md-12 col-sm-12 col-12" >
                                        ...
                                        <div class="colbor col-xl-9 col-lg-12 col-md-12 col-sm-12 col-6" style="display:none;">
                                            <div class="ech-td">
                                                <label class="td-label">Line Total</label>
                                                <div class="td-value">
                                                    <input type="number" step="0.01" id="dis_linetotal_{{$i}}" class="dis_linetotal dis_linetotal_{{$i}} form-control" name="dis_linetotal[]" readonly="" >
                                                </div>
                                            </div>
                                        </div>
...
<div class="row" >
    <div class="col-sm-4" >
        ...
        <div class="form-group row">
            <label for="reffer" class="col-sm-5 col-form-label">Total</label>
            <div class="col-sm-7">
    ...
    <div class="col-sm-4">
                <div class="form-group row">
                <label for="referral" class="col-sm-5 col-form-label">Payment Type </label>
                <div class="col-sm-7">
...
<script>
    ...
    $(document).ready(function() {
        ...
        // // Event listener
        // $('input[name="extype"]').change(function () {
        //     toggleSupplierBox();
        // });

        // function toggleSupplierBox() {
        //     if ($('#supplierOption').is(':checked')) {
        //         $('#supplierSelectBox').show();
        //         $('#customer').prop('required', true);
        //     } else {
        //         $('#supplierSelectBox').hide();
        ...
        $.ajax({
           type:'POST',
           url:"{{ url('admin/code') }}",
           data:{_token: "{{ csrf_token() }}",type:'purchaseorder'},
           success:function(data){
                                ...
                                +'<div class="row">'
                                    ...
                                    +'<div class="colbor col-xl-2 col-lg-4 col-md-4 col-sm-12 col-12">'
                                        +'<div class="ech-td">'
                                            ...
                                            +'<div class="td-value"><input min="1" type="number"  step="0.01"  id="unitprice_'+val+'" required class="unitprice_'+val+' form-control" onChange="price_calc('+val+')" name="unitprice[]"></div></div></div>' 
                                            +'<div class="colbor col-xl-2 col-lg-4 col-md-4 col-sm-12 col-12">'
                                            +'<div class="ech-td">'
                                    ...
                                    +'<div class="colbor col-xl-9 col-lg-12 col-md-12 col-sm-4 col-6" style="display :none;">'
                                        +'<div class="ech-td">'
                                            +'<label class="td-label">Line Total</label>'
...
function calculate_footerdiscount(val=0)
{
    ...
    $("#purchase-order-submit").submit(function(e){
    ...
    $.ajax({
        ...
        success: function(data) {
            ...
            if (data.success) {
                ...
                // window.location.href = 'purchase-order/' + data.puchaseorder_id;
                window.location.href = 'goods-expense';
            }
        },
...
$(document).on('click', '.remove-row', function(e) {
    ...
    // AJAX call for closing the Goods Receipt PO item
    $.ajax({
