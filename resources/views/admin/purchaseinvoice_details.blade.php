@extends('layouts.vertical', ["page_title"=> "Purchase Invoice Details"])
@section('css')
<!-- third party css -->
...
<div class="container-fluid hidden-tab">
            ...
            <div class="page-title-box">
                <div class="page-title-right">
                    <ol class="breadcrumb m-0">
                        <li class="breadcrumb-item"><a href="{{url('admin/purchase_invoice')}}">Purchase Invoice</a></li>
                        <li class="breadcrumb-item active">Purchase Invoice Details</li>
                    </ol>
                </div>
                <h4 class="page-title">Purchase Invoice Details</h4>
            </div>
        </div>
        <div class="col-lg-12 col-md-3 col-5 mb-2 pdf">
            <div class="text-lg-end float-end">
                <a href="{{url('/admin/purchaseinvoicepdf/'.$details->id)}}"class="btn btn-primary waves-effect waves-light">View as PDF</a>
            </div>
        </div>
        <!-- <div class="col-lg-12">
    ...
    <div class="row">
        <div class="col-xl-12 col-lg-12">
            ...
            <div class="card-body body-style2 purchaseOrder table-spcl4 purchaseinvoice-style">
