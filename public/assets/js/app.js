    ...
    (function ($) {
        ...
        (RightBar.prototype.selectOptionsFromConfig = function () {
            ...
            if (config) {
                ...
                $(
                    "input[type=checkbox][name=width][value=" +
                        config.width +
                        "]"
                ).prop("checked", true);
                $(
            ...
            (RightBar.prototype.init = function () {
                ...
                // menus-position
                $("input[type=checkbox][name=menus-position]").change(
                    function () {
                ...
                // left sidebar color
                $("input[type=checkbox][name=leftsidebar-color]").change(
                    function () {
                ...
                // left sidebar size
                $("input[type=checkbox][name=leftsidebar-size]").change(
                    function () {
                ...
                // topbar
                $("input[type=checkbox][name=topbar-color]").change(
                    function () {
