...
class SalesInvoiceMaster extends Model
{
    use HasFactory;    

    public function Items()
    {
        return $this->hasMany(SalesInvoiceItem::class,'sm_id', 'sm_id')->orderBy('id');
    }

    public function Item_details()
    {
        return $this->hasMany(SalesInvoiceItem::class,'sm_id', 'id')->orderBy('id');
    }
