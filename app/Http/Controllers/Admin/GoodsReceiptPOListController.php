...
class GoodsReceiptPOListController extends Controller
{
    ...
    {
        $details = SalesOrder::select('quotations.*')->with(array('Items.products.stock.warehouse', 'customer', 'referral1', 'referral2'))->find($id); //print_r($details);
